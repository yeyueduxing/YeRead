...
class NovelBook {
  ...
  NovelBook({this.author, this.superscript, this.allowMonthly, this.latelyFollower, this.title, this.lastChapter, this.shortIntro, this.tags, this.cover, this.sizetype, this.majorCate, this.site, this.minorCate, this.retentionRatio, this.sId, this.banned, this.contentType});
